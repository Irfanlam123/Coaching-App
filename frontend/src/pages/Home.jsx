      ...
      <section className="py-16 bg-blue-50 relative">
        <div className="absolute inset-0 opacity-10">
          <div
            ...
            style={{
              backgroundImage:
                "url('data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23000000' fill-opacity='0.1'%3E%3Cpath d='M0 0h20v20H0V0zm10 17a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm0-11a4 4 0 1 1 0 8 4 4 0 0 1 0-8z'/%3E%3C/g%3E%3C/svg%3E')",
            }}
          ></div>
        </div>
